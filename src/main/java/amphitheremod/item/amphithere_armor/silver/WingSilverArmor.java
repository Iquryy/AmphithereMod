package amphitheremod.item.amphithere_armor.silver;
...
public class WingSilverArmor extends ArmorBase {
    public WingSilverArmor(ArmorMaterial material, EntityEquipmentSlot slot, String name, CreativeTabs tab) {
